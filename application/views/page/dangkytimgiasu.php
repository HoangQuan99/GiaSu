<div class="pageBody clearfix">
 ...
 <div class="col_c">
    ...
    <div class="formOut clearfix">
        <form method="POST" action="<?php echo base_url() ?>handling/dangkytimgiasu2">                            
            <div class="formOut_line clearfix">
                <p class="formOut_lab">Họ tên (<span>*</span>)</p>
                <div class="formOut_field">
                    <input type="text" required="true" id="fullname" name="fullname" value="" class="in_405">
                </div>                            
            </div>
                ...
                <div class="formOut_field clearfix">
                    ...
                    <select name="id_lop" id="id_lop">
                        <option value="">Chọn lớp</option>
                                                    ...
                                                    <option value="16">Dạy Các Môn Bằng Tiếng Anh</option>
            ...
            <div class="formOut_line clearfix">
                ...
                <input type="submit"  value="ĐĂNG KÝ" class="btn_s3">  
            </p>   
